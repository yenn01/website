<script>
	...
	import { readingTime, convertEpochToDisplayDate } from '$lib/utils';
...
<svelte:head>
	<title>{data.body.tags.ymooi_title}</title>
	<meta property="og:type" content="article" />
	<link
		href="https://cdnjs.cloudflare.com/ajax/libs/prism/9000.0.1/themes/prism-okaidia.min.css"
		rel="stylesheet"
	/>
	<meta property="og:title" content={data.body.tags.ymooi_title} />
</svelte:head>

<article>
	<hgroup>
		<h1>{data.body.tags.ymooi_title}</h1>
		<p>Published on {convertEpochToDisplayDate(data.body.tags.ymooi_date)}</p>
		<div class="tags">
