...
<DefaultHighlight>
	<h2>
		<em>4</em>
		<br /><small>years working with</small>
		<br /><a class="language" href="https://www.anaconda.com/" target="_blank">Anaconda</a>
		<br /><small>related tasks</small>
	</h2>

	<img src="/anaconda.png" class="anacondaLogo" alt="The Anaconda Logo" />
...
<style>
	...
	.language {
		...
		color: #3eb049; /*Anaconda logo Colour*/
